...
-  **KPI Indicators & Tables:** Used **Cards** to display key metrics and **Tables** to provide granular, sortab
-  **Dashboard Design:** Designed an intuitive and visually appealing layout, exploring both common and uncommon types to best tell the data story.
...
![Dash Borad page 1](/page1.png)

###page 2: Drill through job title

![Dash Board page 2](/page2.png)
